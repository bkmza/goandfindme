...
namespace GO.Common.Droid.Services
{
   ...
   public class LocationService : Service, ILocationListener
   {
      ...
      public void OnLocationChanged(Location location) => LocationChanged(this, new LocationChangedEventArgs(location));

      public void OnProviderDisabled(string provider) => ProviderDisabled(this, new ProviderDisabledEventArgs(provider));

      public void OnProviderEnabled(string provider) => ProviderEnabled(this, new ProviderEnabledEventArgs(provider));

      public void OnStatusChanged(string provider, Availability status, Bundle extras) => StatusChanged(this, new StatusChangedEventArgs(provider, status, extras));
   }
}